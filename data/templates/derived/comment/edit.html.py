...
_magic_number = 5
_modified_time = 1297452595.671
_template_filename='D:\\PyProjects\\SimpleSite\\simplesite\\templates/derived/comment/edit.html'
_template_uri='/derived/comment/edit.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\r\n<p>Editing comment:</p>\r\n\r\n')
        # SOURCE LINE 10
        __M_writer(escape(h.form_start(h.url(pageid=c.page.id, controller='comment', action='save',
...
def render_heading(context):
    ...
    try:
        ...
        __M_writer = context.writer()
        # SOURCE LINE 4
        __M_writer(u'\r\n    <h1 class="main">Editing comment</h1>\r\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
