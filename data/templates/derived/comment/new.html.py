...
_magic_number = 5
_modified_time = 1297450914.911
_template_filename='D:\\PyProjects\\SimpleSite\\simplesite\\templates/derived/comment/new.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\r\n')
        # SOURCE LINE 8
        __M_writer(escape(h.form_start(h.url(pageid=c.page.id, controller='comment', action='create'), method="post")))
        __M_writer(u'\r\n    ')
        # SOURCE LINE 9
